...
- [ ] Create annotated tag: `git tag -a v3.0.2 -m "Glider v3.0.2"`.
- [ ] Push release commit and tag: `git push origin main --follow-tags`.

## Post-release

- [ ] Run `venv\Scripts\python.exe verify_release.py --version 3.0.2` after push.
- [ ] Verify GitHub shows tag `v3.0.2` and the release commit.
